...
| Command | Description |
| --- | --- |
| **`/pause`** | *Pause generated Discord responses in the current channel while continuing to send your messages to SillyTavern* |
| **`/resume`** | *Resume generated Discord responses in the current channel* |
